  ...
  return (
    <div id="FAQ" className="FAQ">
      ...
      <div id="question1" className="question_left">
        {question('Quem pode se tornar aprendiz?', answer1)}</div>
      <div id="question2" className="question_right">
        {question('Quem pode se tornar mentor(a)?', answer2)}</div>
      <div id="question3" className="question_left">
        {question('Como uma aprendiz obtém o certificado?', answer3)}</div>
      <div id="question4" className="question_right">
        {question('Como um(a) mentor(a) obtém certificados?', answer4)}</div>
      <div id="question5" className="question_left">
        {question('Como solicitar um(a) mentor(a)?', answer5)}</div>
      <div id="question6" className="question_right">
        {question('Como solicitar uma aprendiz?', answer6)}</div>
      <div id="question7" className="question_left">
        {question('Como remover um(a) mentor(a)?', answer7)}</div>
      <div id="question8" className="question_right">
        {question('Como remover uma aprendiz?', answer8)}</div>
      <br />
    </div>
  );
}
