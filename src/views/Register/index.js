            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="register__inputs">
                <label>
                  <p>nome</p>
                  <input
                    type="text" name="name" ref={register({
              ...
              <div className="register__options">
                <div className="register__options--user">
                  ...
                  <label htmlFor="mentor">
                    <input name="userType" value="mentor" type="radio" ref={register} />
                    {' '}
                    mentor
</label>
                  <label htmlFor="learner">
                    <input name="userType" value="aprendiz" type="radio" ref={register} defaultChecked />
                    {' '}
                    aprendiz
</label>
                </div>
                <label htmlFor="agree">
                  <input
                    name="agree" type="checkbox" ref={register({
                        required: 'concorde com os termo de consentimento',
                      })}
                  /> Concordo que este tutorial é somente para aqueles que se identificam com o gênero feminino.
                </label>
