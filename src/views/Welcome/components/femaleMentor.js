  ...
  return (
    <>
      <div>
        ...
        <p>Infelizmente, você ainda não é uma mentora validada na plataforma, então não poderá ajudar as aprendizes a concluir o
          tutorial introdutório de Django</p>
        <p>Para que você se torne uma de nossas mentoras validadas, precisamos que você passe por uma avaliação
