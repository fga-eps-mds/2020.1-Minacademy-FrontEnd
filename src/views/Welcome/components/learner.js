  ...
  return (
    <>
        <div id='welcome-learner' className='welcome-learner'>
            ...
            <p>Vamos começar pelo principal, para você que esta cadastrada como aprendiz, você poderá acessar o nosso tutorial,
            ...
            <p>E ao concluir todas as atividades do tutorial você receberá um certificado da Minacademy, que poderá ser consultado,
              compartilhado e baixado quando você quiser. Não somente isso como você será automáticamente promovida para mentora
